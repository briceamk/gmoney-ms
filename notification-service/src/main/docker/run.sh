...
echo ">>>>>>>>>>>>>>>>> Starting GMONEY Notification...."

echo "##################################################"
echo "GMONEY - Notification Service"
echo "##################################################"
java -Dspring.profiles.active=$PROFILE -jar -Xmx2048m -Xss256k /usr/local/notification/@project.build.finalName@.jar