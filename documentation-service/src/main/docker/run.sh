...
echo ">>>>>>>>>>>>>>>>> Starting GMONEY Documentation......."

echo "##################################################"
echo "GMONEY - Docuementation Service"
echo "##################################################"
java -Dspring.profiles.active=$PROFILE -jar -Xmx2048m -Xss256k /usr/local/documentation/@project.build.finalName@.jar