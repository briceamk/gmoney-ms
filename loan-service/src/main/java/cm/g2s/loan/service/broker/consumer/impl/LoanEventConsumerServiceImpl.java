...
public class LoanEventConsumerServiceImpl implements LoanEventConsumerService {
    ...
    @Override
    @StreamListener(target = "sendMoneyResponseChannel")
    ...
    @Override
    @StreamListener(target = "confirmAccountDebitResponseChannel")
    public void observeConfirmAccountDebitResponse(@Payload  ConfirmDebitAccountResponse confirmDebitAccountResponse) {
        ...
        loanManagerService.processConfirmAccountDebitResponse(null, confirmDebitAccountResponse.getLoanId(), confirmDebitAccountResponse);
    }
