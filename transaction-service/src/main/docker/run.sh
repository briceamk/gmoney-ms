...
echo ">>>>>>>>>>>>>>>>> Starting GMONEY Trnsaction......."

echo "##################################################"
echo "GMONEY - Trnsaction Service"
echo "##################################################"
java -Dspring.profiles.active=$PROFILE -jar -Xmx2048m -Xss256k /usr/local/transaction/@project.build.finalName@.jar