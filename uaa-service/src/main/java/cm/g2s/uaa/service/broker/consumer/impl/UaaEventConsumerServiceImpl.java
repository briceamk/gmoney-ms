...
public class UaaEventConsumerServiceImpl implements UaaEventConsumerService {
    ...
    @StreamListener(target = "partnerCreatePartnerResponseChannel", condition = "headers['partner'] == 'createPartnerResponse'")
    ...
    @StreamListener(target = "accountCreateAccountResponseChannel", condition = "headers['account'] == 'createAccountResponse'")
