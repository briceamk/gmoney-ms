...
SELECT
'mobile', '{bcrypt}$2y$12$/hFpaWtGjPIbE2v4tMBipeZ8Oos2/77EAUnZjaucflR9VRjYAliEW', 'http://localhost:8080/code', 'READ,WRITE', '3600', '10000', 'account,company,partner,rule,loan,uaa,cron,transaction,notification,momo', 'authorization_code,password,refresh_token,implicit', '{}'
WHERE NOT EXISTS (
